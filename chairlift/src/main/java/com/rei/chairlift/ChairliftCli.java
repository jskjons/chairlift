...
public class ChairliftCli {
    public static void main(String[] args) throws ArtifactResolutionException, IOException {
        ...
        ChairliftConfig globalConfig = new ChairliftConfig(!batch, !noResolve, params);
        if (command.equals("generate")) {
            new Chairlift(globalConfig).generate(templateGav, subtemplate, Paths.get(".").toAbsolutePath());
        }
    }
