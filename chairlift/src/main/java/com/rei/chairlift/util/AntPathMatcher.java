 ...
 *
 * <p>
 *     Class originally from Lazybones and before it spring-core.  Lazybones Modified to keep all logic in one class.  All original javadoc has been 
 *     maintained
 * </p>
 *
 * <p>
...
public class AntPathMatcher {
    ...
    protected boolean doMatch(String pattern, String path, boolean fullMatch,
        ...
        String[] pattDirs = tokenizeToStringArray(pattern, pathSeparator, trimTokens, true);
        String[] pathDirs = tokenizeToStringArray(path, pathSeparator, trimTokens, true);
        ...
        public boolean matchStrings(String str, Map<String, String> uriTemplateVariables) {
            ...
            if (matcher.matches()) {
                if (uriTemplateVariables != null) {
                    // SPR-8455
                    isTrue(variableNames.size() == matcher.groupCount(),
